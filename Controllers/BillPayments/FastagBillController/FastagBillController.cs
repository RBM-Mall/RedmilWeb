...
using Project_Redmil_MVC.Models.RequestModel.FastagBillRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.FastagBillResponseModel;
using System.Net.NetworkInformation;
using System.Reflection;

namespace Project_Redmil_MVC.Controllers.BillPayments.FastagBillController
{
    public class FastagBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public FastagBillOperatorListResponseModel lstOperatorResponse;

        public FastagBillController(IConfiguration config)
        {
            _config = config;
            Baseurl = HelperMethod.GetBaseURl(_config);
        }
        public IActionResult FastagBill()
        {
            ...
            ViewBag.Operator = new SelectList(GetOperatorList(), "Id", "Operatorname");
            return View();
        }
        ...
        public JsonResult FetchBill(string Number, string Operator, string Input1, string Input2, string ccf, string Amount, string Payment)
        {
            ...
            FastagBillOperatorListRequestModel requestModel = new FastagBillOperatorListRequestModel();
            try
            {
                requestModel.Userid = "NA";
                requestModel.State = "";
                requestModel.Category = "Fastag";
                ...
                else
                {
                    ...
                    lstOperatorResponse = JsonConvert.DeserializeObject<FastagBillOperatorListResponseModel>(datadeserialize.ToString());
