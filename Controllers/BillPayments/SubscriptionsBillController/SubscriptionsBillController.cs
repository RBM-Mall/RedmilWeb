...
using Project_Redmil_MVC.Models.RequestModel.SubscriptionsBillRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.SubscriptionsBillResponseModel;
using System.Net.NetworkInformation;

namespace Project_Redmil_MVC.Controllers.BillPayments.SubscriptionsBillController
{
    public class SubscriptionsBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public SubscriptionBillOperatorListResponseModel lstOperator;
        public SubscriptionsBillController(IConfiguration config)
        {
            _config = config;
            Baseurl = HelperMethod.GetBaseURl(_config);
        }
        public IActionResult SubscriptionsBill()
        {
        ...
        #region GetSubscriptionsOperatorList
        public List<Operatornames> GetOperatorList()
        {
            SubscriptionBillOperatorListRequestModel requestModel = new SubscriptionBillOperatorListRequestModel();
            requestModel.Userid = "NA";
            requestModel.State = "";
            requestModel.Category = "Subscription";
        ...
        public JsonResult FetchBill(string Number, string Input1, string Input2, string Operator, string ccf, string Amount, string Payment)
        {
            ...
            var deserialize = JsonConvert.DeserializeObject<BaseResponseModel>(response.Content);
            var datadeserialize = deserialize.Data;
            lstOperator = JsonConvert.DeserializeObject<SubscriptionBillOperatorListResponseModel>(datadeserialize.ToString());
