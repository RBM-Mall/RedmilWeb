...
using Project_Redmil_MVC.Models.RequestModel.ClubAndAssociationRequestModel;
using Project_Redmil_MVC.Models.RequestModel.ElectricityBillRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ClubAndAssociationResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using System.Net.NetworkInformation;

namespace Project_Redmil_MVC.Controllers.BillPayments.ClubAndAssociationBillController
{
    public class ClubAndAssociationBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public ClubAndAssociationOperatorListResponseModel lstOperatorResponse;
        public ClubAndAssociationBillController(IConfiguration config)
        {
            _config = config;
            Baseurl = HelperMethod.GetBaseURl(_config);
        }
        public IActionResult ClubAndAssociationBill()
        {
        ...
        public JsonResult FetchBill(string Number, string input1, string input2, string Operator, string ccf, string Amount, string Payment)
        {
            ...
            ClubAndAssociationOperatorListRequestModel requestModel = new ClubAndAssociationOperatorListRequestModel();
            try
            {
                requestModel.Userid = "NA";
                requestModel.State = "";
                requestModel.Category = "Clubs And Associations";
                ...
                else
                {
                    ...
                    if (deserialize.Statuscode == "TXN" && deserialize != null)
                    {
                        ...
                        lstOperatorResponse = JsonConvert.DeserializeObject<ClubAndAssociationOperatorListResponseModel>(datadeserialize.ToString());
        ...
        #region GetClubAndAssociationOperatorList
        public List<Operatornames> GetOperatorList()
        {
            ...
            try
            {
                ...
                {
                    var datadeserialize = deserialize.Data;
                    var deserializeN = JsonConvert.DeserializeObject<ClubAndAssociationOperatorListResponseModel>(datadeserialize.ToString());
