...
using Project_Redmil_MVC.Models.RequestModel.LifeInsuranceBillRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.LifeInsuranceBillResponseModel;
using System.Net.NetworkInformation;

namespace Project_Redmil_MVC.Controllers.BillPayments.LifeInsuranceBillController
{
    public class LifeInsuranceBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public LifeInsuranceOperatorListResponseModel lstOperator;
        public LifeInsuranceBillController(IConfiguration config)
        {
            _config = config;
            Baseurl = HelperMethod.GetBaseURl(_config);
        }
        public IActionResult LifeInsuranceBill()
        {
        ...
        public JsonResult FetchBill(string Number, string Input1, string Input2, string Operator, string ccf, string Amount, string Payment)
        {
            ...
            LifeInsuranceOperatorListRequestModel requestModel = new LifeInsuranceOperatorListRequestModel();
            try
            {
                requestModel.Userid = "NA";
                requestModel.State = "";
                requestModel.Category = "Life Insurance";
                ...
                else
                {
                    ...
                    if (deserialize.Statuscode == "TXN" && deserialize != null)
                    {
                        ...
                        lstOperator = JsonConvert.DeserializeObject<LifeInsuranceOperatorListResponseModel>(datadeserialize.ToString());
                                    ...
                                    if (deserializeN.Statuscode == "TXN" && deserializeN != null)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(Amount) && (!string.IsNullOrEmpty(ccf)) && (!string.IsNullOrEmpty(Payment)))
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                {
                                                    var deserializeFinal = JsonConvert.DeserializeObject<BaseBillResponseModel>(responseN1.Content);
                                                    if (deserializeFinal.Statuscode == "TXN" && deserializeFinal != null)
                                                    {
                                                        var dataFinal = deserializeFinal.Data;
                                                        {
                                                    ...
                                                    else if (deserializeFinal.Statuscode == "ERR")
                                                    {
                                                        return Json(deserializeFinal);
                                                    }
                                                    else
                                                    {
        ...
        #region GetLifeInsuranceOperatorList
        public List<Operatornames> GetOperatorList()
        {
            ...
            try
            {
                ...
                {
                    var datadeserialize = deserialize.Data;
                    var deserializeN = JsonConvert.DeserializeObject<LifeInsuranceOperatorListResponseModel>(datadeserialize.ToString());
        ...
        #region GetLifeInsuranceOperatorListById
