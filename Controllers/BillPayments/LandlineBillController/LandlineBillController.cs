...
using Project_Redmil_MVC.Models.RequestModel.LandlinePostpaidRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.LandlinePostpaidResponseModel;
using System.Net.NetworkInformation;

namespace Project_Redmil_MVC.Controllers.BillPayments.LandlineBillController
{
    public class LandlineBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public GetLandlineOperatorListResponseModel lstOperatorResponse;
        public LandlineBillController(IConfiguration config)
        {
            _config = config;
            Baseurl = HelperMethod.GetBaseURl(_config);
        }
        public IActionResult LandlineBill()
        {
        ...
        {
            GetLandlineOperatorListRequestModel requestModel = new GetLandlineOperatorListRequestModel();
            try
            {
                requestModel.Userid = "NA";
                requestModel.State = "";
                requestModel.Category = "Landline Postpaid";
                ...
                if (deserialize.Statuscode == "TXN" && deserialize != null)
                {
                    ...
                    lstOperatorResponse = JsonConvert.DeserializeObject<GetLandlineOperatorListResponseModel>(datadeserialize.ToString());
        ...
        public List<Operatornames> GetOperatorList()
        {
            ...
            try
            {
                ...
                {
                    var datadeserialize = deserialize.Data;
                    var deserializeN = JsonConvert.DeserializeObject<GetLandlineOperatorListResponseModel>(datadeserialize.ToString());
