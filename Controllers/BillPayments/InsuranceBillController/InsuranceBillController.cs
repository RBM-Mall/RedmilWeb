...
using Project_Redmil_MVC.Models.RequestModel.InsurancePremiumBillRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.InsurancePremiumBillResponseModel;
using System.Net.NetworkInformation;

namespace Project_Redmil_MVC.Controllers.BillPayments.InsuranceBillController
{
    public class InsuranceBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public InsurancePremiumOperatorListResponseModel lstOperator;
        public InsuranceBillController(IConfiguration config)
        {
            _config = config;
        ...
        public JsonResult FetchBill(string Number, string Input1, string Input2, string Operator, string ccf, string Amount, string Payment)
        {
            ...
            InsurancePremiumOperatorListRequestModel requestModel = new InsurancePremiumOperatorListRequestModel();
            try
            {
                requestModel.Userid = "NA";
                requestModel.State = "";
                requestModel.Category = "Insurance";
                ...
                else
                {
                    ...
                    if (deserialize.Statuscode == "TXN" && deserialize != null)
                    {
                        ...
                        lstOperator = JsonConvert.DeserializeObject<InsurancePremiumOperatorListResponseModel>(datadeserialize.ToString());
        ...
        #region GetInsurancePremiumOperatorList
        public List<Operatornames> GetOperatorList()
        {
            ...
            try
            {
                ...
                {
                    var datadeserialize = deserialize.Data;
                    var deserializeN = JsonConvert.DeserializeObject<InsurancePremiumOperatorListResponseModel>(datadeserialize.ToString());
