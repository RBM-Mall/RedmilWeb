...
using Project_Redmil_MVC.Models.RequestModel.MunicipialServicesRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.MunicipialServicesResponseModel;
using System.Net.NetworkInformation;

namespace Project_Redmil_MVC.Controllers.BillPayments.MunicipialServicesBillController
{
    public class MunicipialServicesBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public MunicipialServicesResponseModel lstOperator;
        public MunicipialServicesBillController(IConfiguration config)
        {
            _config = config;
            Baseurl = HelperMethod.GetBaseURl(_config);
        }

        public IActionResult MunicipialServicesBill()
        {
        ...
        public JsonResult FetchBill(string Number, string Input1, string Input2, string Operator, string ccf, string Amount, string Payment)
        {
            ...
            MunicipialServicesOperatorListRequestModel requestModel = new MunicipialServicesOperatorListRequestModel();
            requestModel.Userid = "NA";
            requestModel.State = "";
            requestModel.Category = "Municipal Services";
            ...
            lstOperator = JsonConvert.DeserializeObject<MunicipialServicesResponseModel>(datadeserialize.ToString());
        ...
        #region GetMunicipalServicesOperatorList
        public List<Operatornames> GetOperatorList()
        {
            ...
            var deserialize = JsonConvert.DeserializeObject<BaseResponseModel>(response.Content);
            var datadeserialize = deserialize.Data;
            var deserializeN = JsonConvert.DeserializeObject<MunicipialServicesResponseModel>(datadeserialize.ToString());
