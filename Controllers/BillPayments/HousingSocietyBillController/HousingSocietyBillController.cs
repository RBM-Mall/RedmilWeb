...
using Project_Redmil_MVC.Models.RequestModel.HousingSocietyRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.HousingSocietyResponseModel;
using System.Net.NetworkInformation;

namespace Project_Redmil_MVC.Controllers.BillPayments.HousingSocietyBillController
{
    public class HousingSocietyBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public HousingSocietyOperatorResponseModel lstOperator;
        public HousingSocietyBillController(IConfiguration config)
        {
            _config = config;
            Baseurl = HelperMethod.GetBaseURl(_config);
        }
        public IActionResult HousingSocietyBill()
        {
        ...
        public JsonResult FetchBill(string Number, string Input1, string Input2, string Operator, string ccf, string Amount, string Payment)
        {
            ...
            HousingSocietyOperatorRequestModel requestModel = new HousingSocietyOperatorRequestModel();
            try
            {
                //var stateID = StateId.Trim();
                requestModel.Userid = "NA";
                requestModel.State = "";
                requestModel.Category = "Housing Society";
                ...
                lstOperator = JsonConvert.DeserializeObject<HousingSocietyOperatorResponseModel>(datadeserialize.ToString());
        ...
        #region HousingSocietyOperatorList
        public List<Operatornames> GetOperatorList()
        {
            ...
            try
            {
                ...
                var deserialize = JsonConvert.DeserializeObject<BaseResponseModel>(response.Content);
                var datadeserialize = deserialize.Data;
                var deserializeN = JsonConvert.DeserializeObject<HousingSocietyOperatorResponseModel>(datadeserialize.ToString());
