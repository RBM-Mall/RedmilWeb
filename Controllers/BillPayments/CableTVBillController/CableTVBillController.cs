...
using Project_Redmil_MVC.Models.RequestModel.CableTVBillRequestModel;
using Project_Redmil_MVC.Models.RequestModel.ElectricityBillRequestModel;
using Project_Redmil_MVC.Models.ResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.CableTVBillResponseModel;
using Project_Redmil_MVC.Models.ResponseModel.ElectricityBillResponseModel;
using System.Net.NetworkInformation;

namespace Project_Redmil_MVC.Controllers.BillPayments.CableTVBillController
{
    public class CableTVBillController : Controller
    {
        private readonly string Baseurl;
        private readonly IConfiguration _config;
        public CableTVBillOperatorListResponseModel lstOperatorResponse;
        public CableTVBillController(IConfiguration config)
        {
            _config = config;
            Baseurl = HelperMethod.GetBaseURl(_config);
        }
        public IActionResult CableTVBill()
        {
        ...
        {
            CableTVBillOperatorListModel requestModel = new CableTVBillOperatorListModel();
            try
            {
                requestModel.Userid = "NA";
                requestModel.State = "";
                requestModel.Category = "Cable TV";
                ...
                if(deserialize.Statuscode=="TXN" && deserialize != null)
                {
                    ...
                    lstOperatorResponse = JsonConvert.DeserializeObject<CableTVBillOperatorListResponseModel>(datadeserialize.ToString());
        ...
        public List<Operatornames> GetOperatorList()
        {
            ...
            try
            {
                ...
                {
                    var datadeserialize = deserialize.Data;
                    var deserializeN = JsonConvert.DeserializeObject<CableTVBillOperatorListResponseModel>(datadeserialize.ToString());
